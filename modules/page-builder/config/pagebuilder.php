...
return [
    ...
    'pagebuilder' => [
        ...
        'url' => '/admin/page-builder-lab/editor',
        'actions' => [
            'back' => '/admin/page-builder-lab'
        ]
    ],
    ...
    'class_replacements' => [
        ...
        \PHPageBuilder\Translator::class => \HansSchouten\LaravelPageBuilder\Services\CustomTranslator::class,
    ],
];
