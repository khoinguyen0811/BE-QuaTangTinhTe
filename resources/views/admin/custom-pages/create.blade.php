...
@section('title', 'Tạo trang tĩnh mới')
    ...
    <div class="card bg-primary-subtle shadow-none position-relative overflow-hidden mb-4">
        <div class="card-body px-4 py-3">
            <div class="d-flex align-items-center justify-content-between">
                <div>
                    <h4 class="fw-semibold mb-1">Tạo trang tĩnh mới</h4>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="title" id="title" class="form-control @error('title') is-invalid @enderror" value="{{ old('title') }}" required placeholder="Ví dụ: Giới thiệu về chúng tôi">
                            @error('title')
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="slug" id="slug" class="form-control @error('slug') is-invalid @enderror" value="{{ old('slug') }}" placeholder="Ví dụ: gioi-thieu (Tự động tạo từ tiêu đề nếu để trống)">
                            </div>
                            @error('slug')
                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="seo_title" id="seo_title" class="form-control" value="{{ old('seo_title') }}" placeholder="Mặc định là tiêu đề trang">
                        </div>

                        <div class="mb-3">
                            <label for="seo_description" class="form-label fw-semibold">SEO Description</label>
                            <textarea name="seo_description" id="seo_description" rows="4" class="form-control" placeholder="Mô tả nội dung trang cho các công cụ tìm kiếm...">{{ old('seo_description') }}</textarea>
                        </div>

                        <div class="mb-3">
                            <label for="seo_image" class="form-label fw-semibold">SEO Share Image (URL)</label>
                            <input type="text" name="seo_image" id="seo_image" class="form-control" value="{{ old('seo_image') }}" placeholder="Đường dẫn ảnh đại diện khi chia sẻ MXH">
                        </div>
                    </div>
                </div>
