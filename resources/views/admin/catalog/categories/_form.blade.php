    ...
    <div class="card-body">
        <div class="row">
            <div class="col-md-12 mb-3">
                ...
                <input type="text" class="form-control" id="name" name="name" value="{{ $name }}" placeholder="{{ __('catalog.placeholders.category_name') }}" required>
            </div>
            <div class="col-md-6 mb-3">
                <label class="form-label" for="slug">{{ __('catalog.fields.slug') }}</label>
                <input type="text" class="form-control" id="slug" name="slug" value="{{ old('slug', $category->slug) }}" placeholder="{{ __('catalog.placeholders.category_slug') }}">
            </div>
            <div class="col-md-6 mb-3">
            ...
            <div class="col-md-6 mb-3">
                ...
                @if($category->image_url)
                    <div class="mt-2">
                        <img src="{{ $category->image_url }}" alt="{{ $name }}" class="rounded border object-fit-cover" width="72" height="72" onerror="this.onerror=null;this.src='{{ asset('admin-assets/js/icons/404.png') }}';">
                    </div>
                @endif
            </div>
            <div class="col-md-12 mb-3">
